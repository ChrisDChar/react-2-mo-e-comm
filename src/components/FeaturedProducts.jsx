            ...
            {featured.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <div className="absolute top-0 left-2 right-2 bottom-[65px] bg-gray-300/30 backdrop-blur-sm flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                    <button className="w-7 h-7 bg-white flex items-center justify-center cursor-pointer">
                    ...
                    <Link to={`/single/${product.id}`} className="w-7 h-7">
                      <div className="w-7 h-7 bg-white flex items-center justify-center cursor-pointer">
