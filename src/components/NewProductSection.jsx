    ...
    <section className="max-w-7xl mx-auto px-4 py-12">
      <div className="flex flex-col lg:grid lg:grid-cols-6 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          <div className="rounded-lg overflow-hidden flex flex-col w-[300px] h-[350px] text-center relative bg-[#F7E99E] p-4">
          ...
          <div className="rounded-lg overflow-hidden flex flex-col w-[300px] h-[210px] relative bg-[#124261] text-center p-4">
